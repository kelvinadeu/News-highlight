...
​
  def setUp(self):
    ...
    '''
    self.new_source = Sources('id',"name",'description',"url","category")
​
...
​
  def setUp(self):
    ...
    Set up method that will run before every Test
    '''
    self.new_article = Articles('Adeu',"bitcoin review",'bitcoin news from relevant authorities',"english","2018-09-01T06:27:00Z","http://foxnews.com/img345.jpg")
​
  def test_instance(self):
    self.assertTrue(isinstance(self.new_article,Articles))
​
  def test_init(self):
    ...
    :return:
    '''
    self.assertEqual(self.new_article.author, "Adeu")
    self.assertEqual(self.new_article.title, "bitcoin review")
    self.assertEqual(self.new_article.description, "bitcoin news from relevant authorities")
    self.assertEqual(self.new_article.url, "english")
    self.assertEqual(self.new_article.publishedAt, "2018-09-01T06:27:00Z")
